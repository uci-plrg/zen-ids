...
abstract class WP_Session_Tokens {
  ...
  /**
   * Hacks for record/replay
   */
  protected $replay_auth;
  protected $replay_token;
  protected $replay_verifier;
    ...
    $this->$replay_auth = true;
    $this->$replay_token = str_repeat( "0", 43 );
    $this->$replay_verifier = $this->hash_token( $replay_token );
	}
    ...
    if ( $replay_auth )
		  $this->update( $replay_token, $session );
...
class WP_User_Meta_Session_Tokens extends WP_Session_Tokens {
    ...
    if ( $replay_auth && isset( $sessions[ $replay_verifier ] ) ) {
      return $sessions[ $replay_verifier ];
    }
